...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДоступнаЗагрузкаКурсов = Метаданные.Обработки.Найти("ЗагрузкаКурсовВалютНБУ") <> Неопределено И ДоступноИзменениеВалют;
...
Процедура ЗагрузитьКурсыВалют(Команда)
	...
	ИмяФормыЗагрузки = "Обработка.ЗагрузкаКурсовВалютНБУ.Форма.Обробка";
