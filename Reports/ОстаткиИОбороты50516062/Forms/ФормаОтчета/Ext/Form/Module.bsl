...
Процедура ОбработатьРезультатНаСервере()
	...
	ЭлементОрганизации = ПараметрыДанныхОСКД.Найти("Организации");

	ЭлементОрганизации.Использование = Ложь;
	Если Организация.Количество() > 0 Тогда
		ЭлементОрганизации = ПараметрыДанныхОСКД.Найти("Организации");
		ЭлементОрганизации.Использование = Истина;
		ЭлементОрганизации.Значение = Организация.ВыгрузитьЗначения();
	КонецЕсли;
