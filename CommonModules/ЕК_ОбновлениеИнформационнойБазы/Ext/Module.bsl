...
Процедура ПослеОбновленияИнформационнойБазы(Знач ПредыдущаяВерсия, Знач ТекущаяВерсия,
	...
	Если ТекущаяВерсия = "1.0.1.004" Тогда
	  // Группа обработчиков, которые выполняются регулярно при каждой смене версии.
		Константы.ТаймаутПодключенияКВебсервису.Установить(30);
	ИначеЕсли ТекущаяВерсия = "1.0.1.006" Тогда
		Константы.ПутьКБазеМММ.Установить("\\10.0.0.250\Scan\MMM2\");
